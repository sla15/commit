                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 py-32 space-y-32">
                    {services.length > 0 ? (
                        ...
                        <div className="text-center py-24 bg-slate-50 border border-dashed border-slate-200 rounded-[3rem]">
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 mb-2">Expanding Our Catalog</h3>
                            <p className="text-slate-500">New service offerings are being updated. Check back soon!</p>
                        </div>
                    )}
                </div>

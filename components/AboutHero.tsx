...
export const AboutHero: React.FC = () => {
    return (
        <div className="relative md:sticky top-0 min-h-[70vh] md:h-[60vh] z-0 flex flex-col items-center justify-center text-center bg-brand-950 overflow-hidden pt-24 pb-32 md:pb-20">
